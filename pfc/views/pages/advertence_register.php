					...
					<form id="form" class="form-group" method="POST" enctype="multipart/form-data">
						...
						<div class="row mt-2">
							<div class="col-12">
								...
								<input type="text" name="responsible" title="Preenchido com o nome do diretor logado." id="responsible" disabled class="form-control">
							</div>
						</div>
                        <div class="row mt-2">
							<div class="col-12">
								<label for="points">Pontos</label>
								<input type="text" name="points" id="points" title="Preenchido de acordo com o motivo." disabled class="form-control">
							</div>
						</div>
                        <div class="row mt-2">
							<div class="col-12">
