...
class MainController{
    ...
    */
    ...
    protected function loadCSS(){
        echo '<link rel="stylesheet" type ="text/css" href="views/assets/css/estilo.css">';
    ...
    protected function loadJavascript(){
        ...
        echo '<script src="views/assets/js/jquery.mask.min.js"></script>';      
		echo '<script src="views/assets/js/common.js"></script>';
